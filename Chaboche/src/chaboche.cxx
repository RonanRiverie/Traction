...
chabocheParametersInitializer::get()
{
static chabocheParametersInitializer i;
return i;
}

chabocheParametersInitializer::chabocheParametersInitializer()
{
this->epsilon = 1e-12;
this->theta = 1;
...
chabocheParametersInitializer::readParameters(*this,"chaboche-parameters.txt");
}

void
chabocheParametersInitializer::set(const char* const key,
const double v){
using namespace std;
...
tfel::raise("chabocheParametersInitializer::set: "
...
double
chabocheParametersInitializer::getDouble(const std::string& n,
const std::string& v)
{
double value;
...
"chabocheParametersInitializer::getDouble: "
"can't convert '"+v+"' to double for parameter '"+ n+"'");
return value;
}

unsigned short
chabocheParametersInitializer::getUnsignedShort(const std::string& n,
const std::string& v)
{
...
converter >> value;
tfel::raise_if(!converter||(!converter.eof()),
"chabocheParametersInitializer::getUnsignedShort: "
"can't convert '"+v+"' to unsigned short for parameter '"+ n+"'");
return value;
}

void
chabocheParametersInitializer::readParameters(chabocheParametersInitializer& pi,const char* const fn){
...
tfel::raise_if(c,"chabocheParametersInitializer::readParameters: "
...
if("epsilon"==tokens[0]){
pi.epsilon = chabocheParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("theta"==tokens[0]){
pi.theta = chabocheParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("RelativeValueForTheEquivalentStressLowerBoundDefinition"==tokens[0]){
pi.relative_value_for_the_equivalent_stress_lower_bound = chabocheParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("minimal_time_step_scaling_factor"==tokens[0]){
pi.minimal_time_step_scaling_factor = chabocheParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("maximal_time_step_scaling_factor"==tokens[0]){
pi.maximal_time_step_scaling_factor = chabocheParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("numerical_jacobian_epsilon"==tokens[0]){
pi.numerical_jacobian_epsilon = chabocheParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("iterMax"==tokens[0]){
pi.iterMax = chabocheParametersInitializer::getUnsignedShort(tokens[0],tokens[1]);
} else {
