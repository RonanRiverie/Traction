/*!
* \file   TFEL/Material/chabocheIntegrationData.hxx
* \brief  this file implements the chabocheIntegrationData class.
*         File generated by tfel version 3.4.1
 */

#ifndef LIB_TFELMATERIAL_CHABOCHE_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_CHABOCHE_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const chabocheIntegrationData<hypothesis,Type,false>&);

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
class chabocheIntegrationData<hypothesis,Type,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const chabocheIntegrationData&);
...
*/
chabocheIntegrationData()
{}

/*!
* \brief Copy constructor
*/
chabocheIntegrationData(const chabocheIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
chabocheIntegrationData(const Type* const CASTEMdt_,
const Type* const CASTEMdT_,const Type* const)
: dt(*CASTEMdt_),dT(*CASTEMdT_)
{
}

void setCASTEMIntegrationDataGradients(const Type* const CASTEMdstran)
{
this->deto.importVoigt(CASTEMdstran);
}
...
chabocheIntegrationData&
>::type
scale(const chabocheBehaviourData<hypothesis,Type,false>&, const Scal time_scaling_factor){
...
*/
chabocheIntegrationData&
updateDrivingVariables(const chabocheBehaviourData<hypothesis,Type,false>&){
return *this;
}

}; // end of chabocheIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
std::ostream&
operator <<(std::ostream& os,const chabocheIntegrationData<hypothesis,Type,false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_CHABOCHE_INTEGRATION_DATA_HXX */
