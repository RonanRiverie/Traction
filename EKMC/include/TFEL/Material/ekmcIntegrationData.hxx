/*!
* \file   TFEL/Material/ekmcIntegrationData.hxx
* \brief  this file implements the ekmcIntegrationData class.
*         File generated by tfel version 3.4.1
 */

#ifndef LIB_TFELMATERIAL_EKMC_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_EKMC_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const ekmcIntegrationData<hypothesis,Type,false>&);

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
class ekmcIntegrationData<hypothesis,Type,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const ekmcIntegrationData&);
...
*/
ekmcIntegrationData(const ekmcIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
ekmcIntegrationData(const Type* const CASTEMdt_,
...
ekmcIntegrationData&
>::type
scale(const ekmcBehaviourData<hypothesis,Type,false>&, const Scal time_scaling_factor){
...
*/
ekmcIntegrationData&
updateDrivingVariables(const ekmcBehaviourData<hypothesis,Type,false>&){
return *this;
}

}; // end of ekmcIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
std::ostream&
operator <<(std::ostream& os,const ekmcIntegrationData<hypothesis,Type,false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_EKMC_INTEGRATION_DATA_HXX */
